...
export class BookingsController {
  ...
  @Post('bookings')
  async createMyBooking(@Request() req: any, @Body() createDto: CreateBookingDto) {
  ...
  @Roles('Admin')
  async updateBookingStatusByAdmin(@Param('id') id: string, @Body() updateDto: UpdateBookingStatusDto) {
